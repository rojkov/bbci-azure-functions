 ...
 */
function _checkDnsNameAvailability(location, options, callback) {
  ...
  let domainNameLabel = (options && options.domainNameLabel !== undefined) ? options.domainNameLabel : undefined;
  let apiVersion = '2017-03-01';
  // Validate
  try {
...
class NetworkManagementClient extends ServiceClient {
   ...
   */
  checkDnsNameAvailabilityWithHttpOperationResponse(location, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._checkDnsNameAvailability(location, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  checkDnsNameAvailability(location, options, optionalCallback) {
    let client = this;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._checkDnsNameAvailability(location, options, optionalCallback);
    }
  }
